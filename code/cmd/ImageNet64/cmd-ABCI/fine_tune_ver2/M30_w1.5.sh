...
mpiexec -n 8 python3.11 cm_train.py $MODEL_FLAGS $CKPT_FLAGS --out_dir /groups/gce50978/user/dongjun/EighthArticleExperimentalResults/ImageNet64/fine_tune_ver2/M30_w1.5 --num_heun_step=30 --discriminator_weight=1.5 --gan_specific_time=True --microbatch=11 --global_batch_size=1056 --lr=0.000008