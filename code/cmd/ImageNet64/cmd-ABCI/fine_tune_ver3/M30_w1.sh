...
mpiexec -n 8 python3.11 cm_train.py $MODEL_FLAGS $CKPT_FLAGS --out_dir /groups/gce50978/user/dongjun/EighthArticleExperimentalResults/ImageNet64/fine_tune_ver3/M30_w1 --num_heun_step=30 --discriminator_weight=1.0 --gan_specific_time=True --microbatch=11 --global_batch_size=2112 --lr=0.000008