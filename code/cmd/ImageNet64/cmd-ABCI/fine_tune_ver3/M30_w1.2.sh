...
CKPT_FLAGS="--resume_checkpoint=/groups/gce50978/user/dongjun/EighthArticleExperimentalResults/ImageNet64/fine_tune_ver2/M30_w1/model018000.pt --ref_path=/home/acf15618av/EighthArticleExperimentalResults/ImageNet64/author_ckpt/VIRTUAL_imagenet64_labeled.npz --teacher_model_path=/home/acf15618av/EighthArticleExperimentalResults/ImageNet64/author_ckpt/edm_imagenet64_ema.pt --data_dir=/groups/gce50978/dataset/imagenet_dir/train"

mpiexec -n 8 python3.11 cm_train.py $MODEL_FLAGS $CKPT_FLAGS --out_dir /groups/gce50978/user/dongjun/EighthArticleExperimentalResults/ImageNet64/fine_tune_ver3/M30_w1.2 --num_heun_step=30 --discriminator_weight=1.2 --gan_specific_time=True --microbatch=11 --global_batch_size=2112 --lr=0.000008