...
mpiexec -n 8 python3.11 cm_train.py $MODEL_FLAGS $CKPT_FLAGS --out_dir /groups/gce50978/user/dongjun/EighthArticleExperimentalResults/ImageNet64/fine_tune_ver3/M20_w1.25 --num_heun_step=20 --discriminator_weight=1.25 --gan_specific_time=True --microbatch=11 --global_batch_size=2112 --lr=0.000008