...
mpiexec -n 8 --allow-run-as-root python cm_train.py $MODEL_FLAGS $CKPT_FLAGS --out_dir /home/ubuntu/EighthArticleExperimentalResults/ImageNet64/fine_tune_ver3/M20_w1_v2 --num_heun_step=20 --discriminator_weight=1.0 --gan_specific_time=True --microbatch=11 --global_batch_size=4224 --lr=0.000008